            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Master Penyakit </a>
                    </div>
                </div>
            </nav>
            <div class="content">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="toolbar">
                                        <button class="btn btn-success" onclick="addPenyakit();">
...
<script src="<?php echo base_url();?>assets/js/apps/penyakit.js"></script>
<script type="text/javascript">
    $(document).ready(function() {
        app_master_penyakit.init();
    });
</script>
        ...
        <div class="modal-content">
        	<form id="fomrMasterPenyakit" method="">
	            	...
	            	<div class="row">
	            		<div class="col-sm-12">
		                    <div class="form-group label-floating">
		                        ...
		                        <input class="form-control" name="kode" id="kode" type="text" required="true"/>
		                    </div>
		            		<div class="form-group label-floating">
		                        <label class="control-label">
		                            Nama
                            ...
                            <!-- <div class="form-group label-floating">
                                ...
                                <input class="form-control" name="harga" id="harga" type="text" required="true" />
                            </div>
		                    <div class="form-group label-floating">
	            ...
	            <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info btn-fill" id="simpanUser" onclick="savePenyakit();">Simpan</button>
