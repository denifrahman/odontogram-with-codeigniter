            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Master Departemen </a>
                    </div>
                </div>
            </nav>
            <div class="content">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="toolbar">
                                        <button class="btn btn-success" onclick="addBidangIlmu();">
...
<script src="<?php echo base_url();?>assets/js/apps/bidang-ilmu.js"></script>
<script type="text/javascript">
    $(document).ready(function() {
        app_bidang_ilmu.init();
    });
</script>
        ...
        <div class="modal-content">
        	<form id="fomrMasterPenyakit" method="">
	            ...
	            <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info btn-fill" id="simpanUser" onclick="saveBidangIlmu();">Simpan</button>
